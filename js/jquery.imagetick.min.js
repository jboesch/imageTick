...
$img_id.click(function(e,coming_from_label){handleClickType.call(this,type,$input_id,coming_from_label);});$("label[for='"+id+"']").click(function(e){e.preventDefault();$img_id.trigger('click',true);});});}})(jQuery);